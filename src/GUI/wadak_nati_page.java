 ...
 * @author #Sanul
 */
public class wadak_nati_page extends javax.swing.JFrame {

    /**
     * Creates new form wadak_nati_page
     */
    public wadak_nati_page() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(wadak_nati_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new wadak_nati_page().setVisible(true);
            }
        });
    }
